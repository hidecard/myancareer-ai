      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <div className="mt-8 md:mt-12 flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-x-6">
            <button
              onClick={onStart}
              className="w-full sm:w-auto rounded-2xl bg-blue-600 px-8 md:px-12 py-4 text-base md:text-lg font-black text-white shadow-xl shadow-blue-500/30 hover:bg-blue-700 hover:shadow-blue-500/40 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600 transition-all transform hover:scale-[1.03] active:scale-95"
            >
              အခုပဲ စစ်ဆေးကြည့်မယ်
            </button>
            <a href="#trends" className="text-sm md:text-base font-black leading-6 text-slate-900 hover:text-blue-600 transition-colors py-2 flex items-center gap-1">
        ...
        <div className="mt-12 md:mt-24 max-w-5xl mx-auto">
          <div className="relative -m-2 rounded-2xl bg-slate-900/5 p-2 ring-1 ring-inset ring-slate-900/10 lg:-m-4 lg:rounded-[3rem] lg:p-4 shadow-2xl">
            <div className="relative rounded-xl md:rounded-[2rem] overflow-hidden shadow-2xl bg-slate-200 aspect-[16/9] md:aspect-[2/1]">
              ...
              <div className="absolute bottom-4 left-4 md:bottom-10 md:left-10 animate-fade-in delay-300">
                <div className="bg-white/90 backdrop-blur px-4 py-2 rounded-xl shadow-lg border border-white/20 flex items-center gap-3">
                   <div className="w-2 h-2 rounded-full bg-emerald-500"></div>
                   <span className="text-[10px] md:text-xs font-black text-slate-900 uppercase tracking-wider">AI Powered Strategy</span>
                </div>
              </div>
            </div>
          </div>
